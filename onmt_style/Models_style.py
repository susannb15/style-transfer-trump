...
"""
Constants for the classifier model
"""
...
class Decoder(nn.Module):
    ...
    def __init__(self, opt, embeddings):
        ...
        self.rnn = StackedLSTM(opt.layers, input_size, opt.rnn_size, dropout)
...
class StyleDecoder(nn.Module):
    ...
    def forward(self, input, target, lengths, enc_hidden, context, bptt=False, with_align =False):
        #src = input[0]
        ...
        out, dec_hidden, _attn = self.decoder(dec_in, enc_hidden, context, init_output)
