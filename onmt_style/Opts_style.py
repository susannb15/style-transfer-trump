...
def model_opts(parser):
    ...
    group.add('--encoder', '-encoder', type=str, default='',
              help='Path to the encoder model(=the backtranslator).')
    group.add('--classifier', '-classifier', type=str, default='',
              help='Path to the classifier model.')
    group.add('--classifier_targets', '-classifier_targets', type=int, default=1, help='Label of the classifier to check = label the decoder is trained on.')
